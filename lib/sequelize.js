...
Sequelize.prototype.query = function(sql, options) {
  ...
  return retry(function() {
    var connection = options.transaction ? options.transaction.connection : self.connectionManager.getConnection(options)
  ...
  }, Utils._.extend(self.options.retry, options.retry || {})).finally(function () {
